<template>
  ...
  >
    <template #description>
      <span class="role-mobile__title">{{ title }}</span>
      <ht-icon
        class="role-mobile__close"
        name="close"
      ...
      >
        <van-checkbox-group v-model="selectIds">
          ...
          >
            ...
            <div class="role-list__container">
              <ht-icon
                name="role"
...
<style lang="scss" scoped>
  .role-mobile__selector {
    ...
    .role-demensions__container {
      padding: 0 12px;
    }
    .role-demensions__group {
      margin-right: 6px;
      color: #999999;
      max-width: 72px;
      overflow: hidden;
