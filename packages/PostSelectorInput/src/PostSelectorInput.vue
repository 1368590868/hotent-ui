<template>
  ...
  >
    <ht-post-selector
      ...
      :show-switch-dimension="showSwitchDimension"
      select-label="name"
  ...
  export default {
    ...
    data() {
      return {
        ...
        orgs: [],
        tableColumns: [
          { prop: 'name', label: this.$t('ht.selector.name') },
          { prop: 'code', label: this.$t('ht.selector.code') },
          { prop: 'orgName', label: this.$t('ht.selector.orgName') },
        ],
        orgLength: 0,
        createQuery: {},
        mode: null, // 搜索模式
