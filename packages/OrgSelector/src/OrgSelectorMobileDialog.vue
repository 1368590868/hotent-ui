<template>
  ...
  >
    <template #description>
      <span class="org-mobile__title">{{ title }}</span>
      <ht-icon
        class="org-mobile__close"
        name="close"
...
<style lang="scss" scoped>
  .org-mobile__selector {
    ...
    .org-demensions__container {
      padding: 0 12px;
    }
    .org-demensions__group {
      margin-right: 6px;
      color: #999999;
      max-width: 72px;
      overflow: hidden;
